...
# Copyright (C) 2018, The Phantom Open Soure Project
#
...
custom_local_manifest = ".repo/local_manifests/phantom_manifest.xml"
custom_default_revision = "baked-release"
custom_dependencies = "phantom.dependencies"
org_manifest = "devices"  # leave empty if org is provided in manifest
org_display = "PhantomDevices"  # needed for displaying
